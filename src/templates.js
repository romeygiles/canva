...
export const PALETTES = [
  ...
  { id: 'ember',    name: 'Ember',         bg: '#fff5ee', ink: '#3d1d14', accent: '#d9542b', soft: '#ffd8c0' },
  // White here is "no ink" on a sublimated mug, so mono plus a transparent
  // background gives bare ceramic with black type — the classic text mug.
  { id: 'mono',     name: 'Mono',          bg: '#ffffff', ink: '#141414', accent: '#141414', soft: '#e8e8e8' },
];
...
export const MUG_TEMPLATES = [
  {
    ...
    fonts: { heading: 'futura', body: 'helvetica' },
    transparent: false,
    fields: { eyebrow: '', headline: 'Still hot. Just occasionally on fire.', message: '', signoff: '' },
  },
  {
    id: 'mug-mono',
    name: 'Mono',
    ...
    transparent: true,
    fields: { eyebrow: '', headline: 'Estrogen left the chat. I stayed.', message: '', signoff: '' },
  },
  {
    id: 'mug-serif',
    name: 'Serif',
    ...
    fonts: { heading: 'didot', body: 'baskerville' },
    transparent: false,
    fields: { eyebrow: '', headline: 'Wise. Warm. Slightly on fire.', message: '', signoff: '' },
  },
  {
    id: 'mug-script',
    name: 'Script',
    ...
    fonts: { heading: 'script', body: 'optima' },
    transparent: false,
    fields: { eyebrow: '', headline: 'Not going through menopause. Growing through it.', message: '', signoff: '' },
  },
  {
    id: 'mug-clinical',
    name: 'Clinical',
    ...
    palette: 'powder',
    decor: 'dots',
    fonts: { heading: 'courier', body: 'courier' },
    transparent: false,
    fields: { eyebrow: '', headline: 'FSH levels: unpredictable.', message: 'Sense of humor: intact.', signoff: '' },
  },
  {
    id: 'mug-night',
    name: 'Night',
    ...
    fonts: { heading: 'didot', body: 'helvetica' },
    transparent: false,
    fields: { eyebrow: 'Caution', headline: 'Hormonal weather system, conditions changing rapidly.', message: '', signoff: '' },
  },
];
